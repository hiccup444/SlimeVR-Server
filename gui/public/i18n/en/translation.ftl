...
settings-adaptive-tracking-title = Adaptive tracking
settings-adaptive-tracking-description = Configure adaptive tracking, experimental pose solving, and diagnostics.
settings-adaptive-tracking-telemetry = Record adaptive telemetry
settings-adaptive-tracking-confidence = Enable tracker confidence diagnostics
settings-adaptive-tracking-foot-contact = Enable foot contact diagnostics
settings-adaptive-tracking-foot-anchoring = Enable foot anchoring
settings-adaptive-tracking-floor-estimation = Learn floor height
settings-adaptive-tracking-floor-estimation-help = Paired planted feet while standing slowly adjust the floor estimate within 3 cm. Disabled by default.
settings-adaptive-tracking-yaw-correction = Enable adaptive yaw correction
settings-adaptive-tracking-yaw-correction-description = Uses eligible planted-foot evidence and observable upper-arm geometry from both hand controllers. Arm correction needs fresh, stable tracking on both arms and both controllers; motion, ambiguous geometry, or missing data pauses it.
settings-adaptive-tracking-pose-optimizer = Experimental weighted pose solver
settings-adaptive-tracking-temperature-learning = Learn temperature-dependent drift
settings-adaptive-tracking-temperature-learning-description = Learns a filter-lag estimate from eligible foot or upper-arm yaw residuals. Requires adaptive yaw correction and fresh acceleration and temperature data.
settings-adaptive-tracking-live-diagnostics = Live diagnostics
settings-adaptive-tracking-live-disconnected = Connect to the server to view live diagnostics.
settings-adaptive-tracking-arm-calibration = Experimental arm calibration
settings-adaptive-tracking-arm-calibration-placeholder = Select a calibration mode
settings-adaptive-tracking-arm-calibration-disabled = Disabled
settings-adaptive-tracking-arm-calibration-proportions = Learn arm proportions
settings-adaptive-tracking-arm-calibration-mounting = Learn tracker mounting
settings-adaptive-tracking-arm-calibration-help = Off by default. Proportions mode requires correct manual tracker mounting; mounting mode requires correct arm lengths. Both need about 60 seconds of stationary time in varied poses.
settings-adaptive-tracking-pose-view = Pose view
settings-adaptive-tracking-pose-front = Front (X/Y)
settings-adaptive-tracking-pose-top = Top (X/Z)
settings-adaptive-tracking-anchor-strength = Foot anchor strength (0 to 1)
settings-adaptive-tracking-sample-rate = Telemetry sample rate (1 to 100 Hz)
settings-adaptive-tracking-yaw-strength = Yaw correction strength (0 to 1)
settings-adaptive-tracking-clear-calibration = Clear learned calibration
settings-adaptive-tracking-clearing-calibration = Clearing learned calibration...
settings-adaptive-tracking-calibration-cleared = Learned calibration cleared.
settings-adaptive-tracking-clear-calibration-error = Could not clear learned calibration. Check the server connection.
settings-adaptive-tracking-save = Save adaptive settings
settings-adaptive-tracking-saved = Settings saved.
settings-adaptive-tracking-saving = Saving settings...
settings-adaptive-tracking-error = Could not save. Check the values and server connection.
